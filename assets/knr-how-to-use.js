(function () {
  var sections = document.querySelectorAll('[data-htu]');
  if (!sections.length) return;

  sections.forEach(function (root) {
    var track = root.querySelector('[data-htu-track]');
    if (!track) return;
    var bar = root.querySelector('[data-htu-progress]');
    var thumb = bar ? bar.querySelector('[data-htu-thumb]') : null;
